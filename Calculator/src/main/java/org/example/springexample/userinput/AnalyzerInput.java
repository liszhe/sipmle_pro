...
public class AnalyzerInput {
    ...
    public static String resultBracket(String input) {
        ...
        while (hasMathOperator(expression)) {
    ...
    public static int getIndexMultiplicationAndDivision(String expression) {
    ...
    public static int getIndexSummationAndSubtraction(String expression) {
    ...
    public static String getResultMultiplicationAndDivision(String expression, int operatorIndex) {
        String result;
    ...
    public static String getResultSummationAndSubtraction(String expression, int operatorIndex) {
        String result;
        char operator = expression.charAt(operatorIndex);
        int leftStart = operatorIndex - 1;
        int rightEnd = operatorIndex + 1;
    ...
    public static boolean hasMathOperator(String input) {
